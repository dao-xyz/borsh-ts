...
exports.deserializeUnchecked = exports.deserialize = exports.serialize = exports.serializeStruct = exports.serializeField = exports.baseDecode = exports.baseEncode = exports.Assignable = void 0;
...
function serializeField(schema, fieldName, value, fieldType, // A simple type of a CustomField
writer) {
    try {
...
function deserializeStruct(schema, clazz, reader) {
    ...
    if (!structSchema) {
        ...
        for (const actualClazz of schema.keys()) {
            if (utils_1.extendsClass(actualClazz, clazz)) {
                const variantIndex = schema_1.getVariantIndex(actualClazz);
    ...
    throw new error_1.BorshError(`Unexpected schema kind: ${structSchema.kind} for ${clazz.constructor.name}`);
}
